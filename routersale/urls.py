...
urlpatterns = [
    ...
    path('paypal_gateway/create_payment/', views.create_payment, name='create_payment'),
    path('paypal_gateway/execute_payment/', views.execute_payment, name='execute_payment'),
